    ...
    function(require, _){
        ...
        */
        ...
        var ApplicationInstance = function App(options, configuration) {
            ...
            // Private variable to store isMobile state
            var isMobile = Device.UA.isMobile();
            //CordovaDevice.isMobile(function(){ isMobile = true; });
             ...
             *
             */
            require(["js-utils/Boilerplate/JQMobileAppDependencies"]);
